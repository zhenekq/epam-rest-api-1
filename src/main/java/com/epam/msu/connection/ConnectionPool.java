package com.epam.msu.connection;
...
public class ConnectionPool {
    ...
    private ConnectionPool() throws WrongPropertiesException {
        try {
        ...
        try {
            ...
            username = applicationProperties.getProperty("db.username");
            password = applicationProperties.getProperty("db.password");
            driverName = applicationProperties.getProperty("db.driver");
        } catch (Exception ex) {
            throw new WrongPropertiesException("Wrong values in db.properties", ex);
        }
    }
    ...
    public void initPoolData() {
        ...
        try {
            ...
            givenAwayConQueue = new ArrayBlockingQueue<Connection>(POOL_SIZE);
